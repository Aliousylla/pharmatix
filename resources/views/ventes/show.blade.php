    ...
    <div class="container p-5 mx-5 shodow ">
      <div class="d-flex justify-content-between">
        ...
        <div class="item text-center text-success">
          ...
          <h4>#000{{$lignes->first()->vente->id}}</h4>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $ligne->medicament->prix_unitaire }}</td>
            <td>{{ $ligne->quantite_vendue }}</td>
            <td>{{ $ligne->medicament->prix_unitaire*$ligne->quantite_vendue }}</td>
          </tr>
          @endforeach
      ...
      <div class="container text-center">
        <div class="row">
          ...
          <div class="col">
          <h2 class="bg-success text-light p-2">Total : {{ $ligne->vente->total }} DHS</h2>
          </div>
        </div>
      </div>
      <div class="col-8">

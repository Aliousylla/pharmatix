 ...
 <div class="container">
    <form method="POST" action="{{ route('medicaments.update', $medicament->id) }}">
        ...
        <div class="form-group mb-3">
            ...
            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" required>{{ old('description', $medicament->description) }}</textarea>
            <div class="invalid-feedback">
        ...
        <div class="form-group mb-3">
            ...
            <input value="{{ old('prix_unitaire', $medicament->prix_unitaire) }}" type="number" name="prix_unitaire" id="prix_unitaire" class="form-control @error('prix_unitaire') is-invalid @enderror" step="0.01" required>
            <div class="invalid-feedback">
